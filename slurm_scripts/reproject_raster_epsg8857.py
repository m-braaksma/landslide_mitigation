...
def main():
    ...
    if len(sys.argv) < 5:
        ...
        print("Usage: python reproject_raster_epsg8857.py <raster_name> <year> <input_s3_path> <output_s3_path> [--force]")
        sys.exit(1)
    ...
    # Define target projection (Equal Earth EPSG:8857)
    srs = osr.SpatialReference()
    srs.ImportFromEPSG(8857)
    ...
    output_filename = f"{raster_name}_epsg8857.tif"
...
# from config.config import BASE_DATA_DIR, PROJ_DATA_DIR, SDR_INPUT_RASTERS
# from utils.s3_utils import s3_handler

# def main():
#     # Get parameters from command line arguments
#     if len(sys.argv) != 3:
#         print("ERROR: Please provide raster_name and year as command line arguments")
#         print("Usage: python reproject_raster_epsg8857.py <raster_name> <year>")
#         sys.exit(1)
...
#     # Get input S3 path from config
#     if raster_name in SDR_INPUT_RASTERS:
#         input_s3_path = BASE_DATA_DIR + SDR_INPUT_RASTERS[raster_name]
#         output_s3_path = PROJ_DATA_DIR + f"invest_sdr_input/{raster_name}_epsg8857.tif"
#     else:
#         print(f"ERROR: Raster '{raster_name}' not found in SDR_INPUT_RASTERS.")
#         sys.exit(1)
